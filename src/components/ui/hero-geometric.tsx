...
void main() {
    ...
    // Enhanced noise with time - more visible movement
    float noise = snoise(uv * 1.5 + vec2(uTime * 0.3, uTime * 0.2)) * 0.3;
    noise += snoise(uv * 3.0 + vec2(-uTime * 0.15, uTime * 0.25)) * 0.15;
